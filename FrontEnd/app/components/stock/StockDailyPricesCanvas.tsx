import { StockDailyPropsInterface, StockInfo, StockPriceInterface } from "@/app/Interfaces/table/StockInfoInterface";
import { CONCAT_NEW_STOCK_PRICE, GET_STOCK_BY_SYMBOL, GET_STOCK_BY_SYMBOL_AND_DATETIME } from "@/app/actions/stockActionsTypes";
import { getStockBySymbol, getStockPricesBySymbolAndDate } from "@/app/api/stockAPIs";
